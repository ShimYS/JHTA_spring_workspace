-- 2020-08-04 spring-mvc 테이블 추가 생성
...
insert into spring_categories values ('유아용품', '유아/아동/완구/애완용품');
...
create table spring_order_products (
...
create table spring_order_delivery (
    ...
    deliver_status varchar2(50) default '물품준비중',
    order_no number(10) REFERENCES spring_orders (order_no)
);
