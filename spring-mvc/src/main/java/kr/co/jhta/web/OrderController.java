...
public class OrderController {
	...
	// (요청방시기:GET, 요청URL:/order/stpe1.do?no=1, 요청파라미터:no)
	@GetMapping("/step1.do")
	...
	// 1단계 화면(구매수량, 구매자이름, 구매자 전화번호, 가격 입력화면)
	// 구매수량, 구매자이름,구매자 전화번호 입력 후 폼입력값 제출햇을 때 실행됨
	// (요청방시기:POST, 요청URL:/order/stpe1.do, 요청파라미터:amount, price, username, usertel)
	...
	// (요청방시기:GET, 요청URL:/order/stpe2.do, 요청파라미터:없음)
	@GetMapping("/step2.do")
	public String step2() {
		return "order/step2";
	}
	...
	// (요청방시기:POST, 요청URL:/order/stpe2.do, 요청파라미터:payType, payAccount)
	...
	// (요청방시기:GET, 요청URL:/order/stpe3.do, 요청파라미터:없음)
	@GetMapping("/step3.do")
	public String step3() {
		return "order/step3";
	}
	...
	// (요청방시기 :POST, 요청URL:/order/stpe3.do, 요청파라미터:receiverName, receiverTel, recie)
	...
	// (요청방시기:GET, 요청URL:/order/stpe4.do, 요청파라미터:없음)
	@GetMapping("/step4.do")
	public String step4() {
		return "order/step4";
	}
	...
	// 주문내용을 확인하고 주문버튼을 클릭했을때  실행됨
	// (요청방시기:POST, 요청URL:/order/stpe4.do, 요청파라미터:no)
	...
	public String step4Submit(@ModelAttribute("orderForm") OrderForm orderForm, SessionStatus sessionStatus) {
		...
		// OrderForm객체에서 주문정보 정장에 필요한 구매자 정보 조회하기
